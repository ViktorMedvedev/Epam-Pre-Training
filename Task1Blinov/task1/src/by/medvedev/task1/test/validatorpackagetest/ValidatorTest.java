package by.medvedev.task1.test.validatorpackagetest;

import by.medvedev.task1.entity.Cone;
import by.medvedev.task1.entity.Point;
import by.medvedev.task1.factory.ConeFactory;
import by.medvedev.task1.factory.PointFactory;
...
public class ValidatorTest {
    ...
    public void isAdequateDiapasonTrue() {
        Cone cone = ConeFactory.createCone(200, PointFactory.createPoint(100, 200, 300), PointFactory.createPoint(100, 200, 500), 500);
